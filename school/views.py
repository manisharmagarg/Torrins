...
class SchoolProfiles(LoginRequiredMixin, View):
	...
	def get(self, request, *args, **kwargs):
		self.context = school_side_bar_menus(request)
		return render(request, 'school/school_profile.html', self.context)
...
class SchoolPostJob(LoginRequiredMixin, View):
	...
	def get(self, request, *args, **kwargs):
		self.context = school_side_bar_menus(request)
		return render(request, 'school/school_post_job.html', self.context)
...
class SchoolBrowseTeacher(LoginRequiredMixin, View):
	...
	def get(self, request, *args, **kwargs):
		self.context = school_side_bar_menus(request)
		return render(request, 'school/school_browse_teacher.html', self.context)
...
class SchoolTrackJob(LoginRequiredMixin, View):
	...
	def get(self, request, *args, **kwargs):
		self.context = school_side_bar_menus(request)
		return render(request, 'school/school_track_job.html', self.context)
...
class SchoolMessage(LoginRequiredMixin, View):
	...
	def get(self, request, *args, **kwargs):
		self.context = school_side_bar_menus(request)
		return render(request, 'school/school_message.html', self.context)
